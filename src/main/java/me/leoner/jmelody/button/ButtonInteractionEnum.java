package me.leoner.jmelody.button;

import lombok.AllArgsConstructor;
import lombok.Getter;
import me.leoner.jmelody.commandold.music.NextCommand;
import me.leoner.jmelody.commandold.music.PauseCommand;
import me.leoner.jmelody.commandold.music.StopCommand;
import me.leoner.jmelody.commandold.music.VolumeCommand;

import java.util.Arrays;
import java.util.List;
import java.util.Optional;

import static me.leoner.jmelody.button.CategoryButtonInteractionEnum.*;
...
public enum ButtonInteractionEnum {
    ...
    public static ButtonInteractionEnum getByButtonId(String buttonId) {
        Optional<ButtonInteractionEnum> item = Arrays.stream(ButtonInteractionEnum.values())
                .filter(value -> value.name().equals(buttonId))
                .findFirst();
